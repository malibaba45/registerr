...
if(!message.member.roles.cache.some(r => ["735262149076582510"].includes(r.id)) && (!message.member.hasPermission("ADMINISTRATOR")))
...
exports.conf = {
    enabled: true,
    guildOnly: true,
    aliases: ["stat", "kayıtlar", "kayıt-kontrol", "kayıtsay"],
    permLvl: 0,
}
