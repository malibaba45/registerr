...
if(!['735262149076582510'].some(role => message.member.roles.cache.get(role)) && !message.member.hasPermission('ADMINISTRATOR')) 
...
const tag = ''   
const kadınrol = message.guild.roles.cache.find(r => r.id === '735264532879900793') 
const kayıtsız = message.guild.roles.cache.find(r => r.id === '735262105149898913')
const genelchat = message.guild.channels.cache.find(c => c.id === '795858120446443580')
const savelog = message.guild.channels.cache.find(c => c.id === '817788599612735560')
